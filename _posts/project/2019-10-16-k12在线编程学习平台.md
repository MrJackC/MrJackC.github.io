---
layout: post
title: Ubuntu16.0.4 部署code-dot-org 项目
category: server
tags: [server]
copyright: mrjason
keywords: k12 blockly computer educational online code
---

Code.org®是一个非营利性组织，致力于扩大学校对计算机科学的访问，并增加妇女和代表性不足的少数民族的参与。 我们的愿景是每所学校的每个学生都有机会学习计算机科学，就像生物学，化学或代数一样。 Code.org在美国最大的学区提供领先的K-12计算机科学课程，并且Code.org还组织了年度“代码小时”活动，该活动吸引了全球15％的学生。 Code.org得到了包括亚马逊，Facebook，谷歌，Infosys基金会，微软等在内的慷慨捐助者的支持。

# Code.org 首页展示

![](https://tva1.sinaimg.cn/large/006y8mN6ly1g802d761zgj31ox0u0kjl.jpg)


# Setup
本文档主要介绍如何本地搭建Code.org 平台并进行本地开发
...
这里的项目有些大,自己克隆到本地的gitlab服务器,防止部署失败。内网环境更快些。
