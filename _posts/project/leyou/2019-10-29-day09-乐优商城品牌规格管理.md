...
![1526085541996](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqd7xhp6j30st0imgpk.jpg)
...
似乎并不复杂，但是大家仔细思考一下，商品的规格字段你如何填写？
 ...
 ![1526086539789](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdykpbxj30cl0c23z1.jpg)
...
> 华为的规格：
 ...
 ![1526087063700](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdx6jn0j30f70e7750.jpg)



> 三星的规格：

 ![1526087142454](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqb6hi0wj30dg0dv0te.jpg)
...
![1526088981953](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqae023aj30sm0cgwgf.jpg)
...
![1526090072535](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdwesa5j30lo092myw.jpg)

你会发现，过滤条件中的屏幕尺寸、运行内存、网路、机身内存、电池容量、CPU核数等，在规格参数中都能找到：

 ![1526090228171](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqbuqx2sj30dd0gkwfm.jpg)
...
也就是说，规格参数中的数据，将来会有一部分作为搜索条件来使用。我们可以在设计时，将这部分属性标记出来，将来做搜索的时候，作为过滤条件。要注意的是，无论是SPU的全局属性，还是SKU的特有属性，都有可能作为搜索过滤条件的，并不冲突，而是有一个交集：
 ...
 ![1526091216124](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdxnpwmj30ay094mxg.jpg)
...
我们看下规格参数的格式：
 ...
 ![1526092179381](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdy7ai4j30ig0bq3zi.jpg)
...
![1529549099049](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe46t2ij30q30b6wfd.jpg)

商品分类树我们之前已经做过，所以这里可以直接展示出来。

因为规格是跟商品分类绑定的，因此首先会展现商品分类树，并且提示你要选择商品分类，才能看到规格参数的模板。一起了解下页面的实现：

 ![1529549521623](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdz4wv7j309907cweq.jpg)

页面结构：

![1528423299102](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe3au8bj30uq0hs76i.jpg)
...
![1529550402376](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdwryllj30zb0cjgmr.jpg)
...
![1529550694218](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqbtc9nlj30o10e5tax.jpg)

可以看到右侧并不是我们熟悉的 `v-data-table`，而是一个`spec-group`组件（规格组）和`spec-param`组件（规格参数），这是我们定义的独立组件：

 ![1529550775415](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqb6v8smj307x07kweq.jpg)

在SpecGroup中定义了表格：

![1528427514717](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdaimeoj31280jmjvq.jpg)
...
![1528428028513](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqb89c49j30sd04lt93.jpg)

我们来看下`handleClick`方法：（Specification.vue）

![1528428221957](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqek6pfbj30sf0e8ta7.jpg)
...
![1528428308113](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqaecdrqj30si051js0.jpg)
...
![1528428617046](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqbturc8j30sd0m6go2.jpg)

我们查看页面控制台，可以看到请求已经发出：

![1528428699027](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqbwa81lj30v00cy0ut.jpg)
...
在`leyou-item-interface`中添加实体类：
 ...
 ![1528429029149](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqejp7z1j30bc09o74p.jpg)
...
在`leyou-item-service`中编写业务：
 ...
 ![1528433648595](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe1ysh5j30b90eu3zf.jpg)
...
- 返回结果：页面是直接把`resp.data`赋值给了groups：
  ...
  ![1528429342796](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqehwmv2j30ss09lmxy.jpg)
...
![1528433697492](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqd9ggi9j30ql0b0wfp.jpg)

我们访问：http://api.leyou.com/api/item/spec/groups/76

![1528433733340](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqd8di0mj30rn0fr75k.jpg)

然后在后台系统中测试：
![1528433821121](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe1f7dnj31320eb0u9.jpg)
...
![1528429949504](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqbu9xs3j30si0eo0ur.jpg)

我们看下事件处理：

![1528429988410](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqadjm0uj30sd048t8x.jpg)
...
![1528430052736](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe0izm6j30t504wt9d.jpg)

事件处理：

![1528430100166](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe0xoqwj30rd06ymxo.jpg)

这里我们记录了选中的分组，并且把标记设置为false，这样规格组就不显示了，而是显示：`SpecParam`

并且，我们把group也传递到`spec-param`组件：

![1528430147829](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdzksi0j30sa059wf5.jpg)
...
![1528430319461](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqbswwb1j30s90m5tai.jpg)

查看页面控制台，发现请求已经发出：

![1528430407298](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdb1x6zj30t70cjq54.jpg)
...
> SpecParamMapper
 ...
 ![1543383516456](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqbv85bhj30by0cj752.jpg)
...
![1528442972016](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqbvnqlyj30vk0k5abv.jpg)
...
> 整体来看：
 ...
 ![1529554390912](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe0026bj308b08kaag.jpg)
...
来看数据格式：
 ...
 ![1529554916252](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe3sta0j30f709gdgk.jpg)
...
因为我们有时候需要把所有规格参数都查询出来，而不是只查询1个sku的属性。比如，商品详情页展示可选的规格参数时：
 ...
 ![1526267828817](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqeiadfhj30hi06n751.jpg)
...
既然如此，我们是不是可以将不同角标串联起来，作为SPU下不同SKU的标示。这就是我们的indexes字段。
 ...
 ![1526266901335](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe2wvf1j30ho075mzk.jpg)

这个设计在商品详情页会特别有用：

 ![1526267180997](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqb7dvopj30hi06n74t.jpg)
...
![1528445149890](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqej81mwj30r008t40h.jpg)

![1528479229165](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqe2bfopj30y00eajty.jpg)
...
![1526268595873](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqb5zyorj30xo0h0770.jpg)
...
![1528447301687](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqd9vf44j30x50ghq54.jpg)

并且在Vue实例挂载后就会发起查询(mounted调用getDataFromServer方法初始化数据)：

![1528447431959](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqd94a7oj30vo0j5q5l.jpg)

我们刷新页面，可以看到浏览器发起已经发起了查询商品数据的请求：

![1528447591939](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqb7ts16j30xh0bkdii.jpg)
...
页面已经准备好，接下来在后台提供分页查询SPU的功能。
 ...
 ![1543414148030](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqeiu6fkj309i09hglz.jpg)

 ![1543413983147](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqdvt0p7j309i0eu0tp.jpg)
...
![1528450054541](https://tva1.sinaimg.cn/large/006y8mN6ly1g8bqb8qumhj316s0hbdi9.jpg)
