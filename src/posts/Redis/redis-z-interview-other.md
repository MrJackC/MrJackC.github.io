...
![image-20220628231834918](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131028682.png)
...
![image-20220628231916751](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131028721.png)

如下图所示，文件事件处理器有四个组成部分，它们分别是套接字、I/O多路复用程序、文件事件分派器以及事件处理器。

![image-20220628231940531](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131028756.png)
...
![image-20220628232005169](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131028795.png)
...
![image-20220628232200617](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/image-20220628232200617.png)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：


![image-20220628232219119](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/image-20220628232219119.png)
...
![image-20220628232251439](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131028822.png)

- **基于模式(pattern)的发布/订阅**

下图展示了一个带有频道和模式的例子， 其中 tweet.shop.* 模式匹配了 tweet.shop.kindle 频道和 tweet.shop.ipad 频道， 并且有不同的客户端分别订阅它们三个：

![image-20220628232314728](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131028869.png)

当有信息发送到 tweet.shop.kindle 频道时， 信息除了发送给 clientX 和 clientY 之外， 还会发送给订阅 tweet.shop.* 模式的 client123 和 client256 ：

![image-20220628232334451](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131028898.png)



另一方面， 如果接收到信息的是频道 tweet.shop.ipad ， 那么 client123 和 client256 同样会收到信息：

![image-20220628232349308](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131028931.png)
