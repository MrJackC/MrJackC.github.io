...
![image-20220628220310533](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037008.png)
...
![image-20220628220842046](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037061.png)

### 2.3 Redis 数据类型有哪些底层数据结构？

![image-20220628220915518](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037094.png)
...
![image-20220628221135429](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037125.png)

### 2.7 Redis Stream用在什么样场景？

可用作时通信等，大数据分析，异地数据备份等

![image-20220628221236545](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037160.png)

客户端可以平滑扩展，提高处理能力

![image-20220628221321712](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037186.png)
...
![image-20220628222023267](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037212.png)
...
![image-20220628222152957](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037241.png)
...
![image-20220628222325269](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037262.png)
...
![image-20220628222410531](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037288.png)
...
![image-20220628222701583](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037310.png)
...
![image-20220628222755767](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037336.png)
...
![image-20220628222858541](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037361.png)
...
![image-20220628223022048](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037385.png)
...
![image-20220628223526301](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037413.png)
...
![image-20220628223740040](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037448.png)
...
![image-20220628224139614](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037477.png)
...
![image-20220628224222691](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037507.png)
...
![image-20220628225658343](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037545.png)
...
![image-20220628225901289](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037568.png)
...
![image-20220628230005184](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037602.png)
...
![image-20220628230047534](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037631.png)
...
![image-20220628230125379](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037657.png)
...
![image-20220628230146608](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037685.png)
...
![image-20220628230308886](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037722.png)

### 6.7 新的主库选择出来后，如何进行故障的转移？

假设根据我们一开始的图：（我们假设：判断主库客观下线了，同时选出`sentinel 3`是哨兵leader）

![image-20220628230332745](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037758.png)

**故障转移流程如下**：

![image-20220628230347436](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037796.png)
...
![image-20220628230408904](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037828.png)
...
![image-20220628231317888](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037869.png)
...
![image-20220628231834918](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037899.png)
...
![image-20220628231916751](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037931.png)

如下图所示，文件事件处理器有四个组成部分，它们分别是套接字、I/O多路复用程序、文件事件分派器以及事件处理器。

![image-20220628231940531](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037955.png)
...
![image-20220628232005169](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037987.png)
...
![image-20220628232200617-1684919697045-787](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/image-20220628232200617-1684919697045-787.png)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：


![image-20220628232219119-1684919697045-789](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/image-20220628232219119-1684919697045-789.png)
...
![image-20220628232251439](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037021.png)

- **基于模式(pattern)的发布/订阅**

下图展示了一个带有频道和模式的例子， 其中 tweet.shop.* 模式匹配了 tweet.shop.kindle 频道和 tweet.shop.ipad 频道， 并且有不同的客户端分别订阅它们三个：

![image-20220628232314728](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037049.png)

当有信息发送到 tweet.shop.kindle 频道时， 信息除了发送给 clientX 和 clientY 之外， 还会发送给订阅 tweet.shop.* 模式的 client123 和 client256 ：

![image-20220628232334451](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037080.png)



另一方面， 如果接收到信息的是频道 tweet.shop.ipad ， 那么 client123 和 client256 同样会收到信息：

![image-20220628232349308](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403131037129.png)
