...
![image-20220724203557314](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404301417264.png)
...
![image-20220724203729888](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404301417314.png)
...
![image-20220724204550517](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404301417343.png)

点击开始按钮，可以看到多个分片的[并发](https://so.csdn.net/so/search?q=并发&spm=1001.2101.3001.7020)请求，最后调用了合并文件接口，并返回了true。

![image-20220724204612100](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404301417368.png)

查看Minio 控制台，可以看到文件大小都一致。

![image-20220724204641755](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404301417390.png)
