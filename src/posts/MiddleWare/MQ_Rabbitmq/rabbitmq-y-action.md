---
aliases: RabbitMQ实战 - Exchange的四种类型以及用法
tags: 
cssclass: 
source: 
order: 810
...
![image-20220922203746317](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122845.png)
...
![image-20220923134359709](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122898.png)
...
![image-20220923134450795](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122926.png)

**这里有个小坑**，一开始RabbitMQ服务器里还没有创建队列：

![image-20220923134505923](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122960.png)

这时如果启动消费者，会报错：

![image-20220923134519919](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122996.png)

要先启动生产者，发送一条消息：

![image-20220923134533831](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122022.png)

![image-20220923134541713](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122047.png)

最后再启动消费者，进行消费：

![image-20220923134553618](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122067.png)

这时候就会持续监听队列的消息，只要生产者发送一条消息到MQ，消费者就消费一条。我这里尝试发送4条：

![image-20220923134609175](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122092.png)
...
![image-20220922204506785](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122122.png)
...
![image-20220923135120900](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122153.png)

使用POSTMAN进行发送消息，测试：

![image-20220923135135310](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122193.png)

然后可以看到控制台，两个队列同时都收到了相同的消息，形成了发布订阅的效果：

![image-20220923135156170](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122221.png)
...
![image-20220922204704979](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122247.png)
...
![image-20220923135517317](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122274.png)

通过POSTMAN进行测试，测试一下 rabbit.# 的路由键是否能够匹配成功：

![image-20220923135534580](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122306.png)

测试成功，队列A消费到消息：

![image-20220923135605396](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122337.png)

接着测试 a.* 路由键，发送 routingKey = a.b ：

![image-20220923135627488](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122368.png)

![image-20220923135634279](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122395.png)
...
![image-20220922204955736](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122420.png)
...
![image-20220923135747132](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122448.png)

跟上面示意图一样~证明没有问题，一切尽在掌握之中。使用POSTMAN发送，测试全匹配的队列A：

![image-20220923135802788](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122473.png)

![image-20220923135808988](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122499.png)

再测试部分匹配的队列B：

![image-20220923135820620](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122539.png)

![image-20220923135827372](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231122568.png)
