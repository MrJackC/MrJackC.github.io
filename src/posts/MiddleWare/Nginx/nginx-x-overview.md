...
![image-20220724221108300](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231128791.png)
...
![image-20220724222601079](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231128835.png)

![image-20220724222610707](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231128864.png)
...
![image-20220724225746333](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231128890.png)

### 2.5 动静分离

为了加快网站的解析速度，可以把动态页面和静态页面由不同的服务器来解析，加快解析速度，降低原来单个服务器的压力。

![image-20220724225816748](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231128909.png)
...
![image-20220805202351667](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231128936.png)
...
![image-20220805202424523](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231128959.png)

### 3.2 相关文件夹

然后我们可以使用 `rpm -ql nginx` 来查看 Nginx 被安装到了什么地方，有哪些相关目录，其中位于 `/etc` 目录下的主要是配置文件，还有一些文件见下图：

![image-20220805202448958](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231128977.png)
...
![image-20220724231052047](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129003.png)
...
![image-20220724231559185](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129031.png)
...
![image-20220726200525259](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129058.png)
...
![image-20220726201508633](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129077.png)
...
![image-20220726201934594](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129100.png)
...
![image-20220726202211312](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129125.png)
...
![image-20220726202442183](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129155.png)
...
![image-20220726202845395](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129182.png)

配置之后 response 的 header 里面多了一个 `Content-Encoding: gzip`，返回信息被压缩了：

![image-20220726202915387](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129217.png)

注意了，一般 gzip 的配置建议加上 `gzip_min_length 1k`，不加的话：

![image-20220726202946349](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129266.png)
...
![image-20220726203056141](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129287.png)
...
![image-20220726203707353](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129314.png)
...
![image-20220726204632802](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231129346.png)
