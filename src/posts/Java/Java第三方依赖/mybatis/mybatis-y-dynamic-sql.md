...
![image-20220729203622877](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550866.png)
...
![image-20220729203745109](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550915.png)

BoundSql类，封装mybatis最终产生sql的类，包括sql语句，参数，参数源数据等参数：

![image-20220729203818827](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550949.png)

XNode，一个Dom API中的Node接口的扩展类：

![image-20220729203850391](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550978.png)

BaseBuilder接口及其实现类(属性，方法省略了，大家有兴趣的自己看),这些Builder的作用就是用于构造sql：

![image-20220729203950526](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550009.png)
...
![image-20220729204118825](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550039.png)
...
![image-20220729204316213](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550065.png)

由于XMLConfigBuilder内部也是使用XMLMapperBuilder，我们就看看XMLMapperBuilder的解析细节：

![image-20220729204341385](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550097.png)

![image-20220729204415735](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550127.png)

我们关注一下，增删改查节点的解析：

![image-20220729204453691](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550156.png)

XMLStatementBuilder的解析：

![image-20220729204514730](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550191.png)

默认会使用XMLLanguageDriver创建SqlSource（Configuration构造函数中设置）。

XMLLanguageDriver创建SqlSource：

![image-20220729204620410](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550223.png)

XMLScriptBuilder解析sql：

![image-20220729204640347](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550255.png)
...
![image-20220729205509165](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550285.png)

trim节点：

![image-20220729205555040](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550318.png)

由于这个update方法是个动态节点，因此构造出了DynamicSqlSource。DynamicSqlSource内部就可以构造sql了:

![image-20220729205618798](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202404231550352.png)
