---
aliases: 'Java Web基础 - Tomcat&Http协议'
tags: 
cssclass:
source:
order: 1
...
updated: "2024-03-12 12:48"
---

# Java Web基础 - Tomcat&Http协议
...
![CS结构图](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246743.jpg)

### 1.3.3 B/S结构

它指的是浏览器——服务器的方式。其中B代表着Browser，S代表着服务器。B/S结构的系统设计图如下：

![BS结构图](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246807.jpg)
...
![tomcat官网](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246843.png)

### 2.1.3 Tomcat各版本所需支持

![Tomcat各版本使用技术支持](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246869.png)

### 2.1.4 Tomcat目录结构详解

![tomcat目录结构详解](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246902.png)
...
Tomcat服务器的启动文件在二进制文件目录中：![1574762703742](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246932.png)，这两个文件就是Tomcat的启动文件。

Tomcat服务器的停止文件也在二进制文件目录中：![1574762805135](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246958.png)，这两个文件就是Tomcat的停止文件。
...
![1574768107180](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246989.png)
...
​			![1574768222804](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246007.png)
...
![IDEA配置Tomcat1](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246032.png)

**第二步**

![IDEA配置Tomcat2](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246057.png)

**第三步**

![IDEA配置Tomcat3](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246081.png)

**第四步**

![IDEA配置Tomcat4](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246104.png)
...
![Linux版Tomcat](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246131.png)
...
![1574768644245](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246165.png)
...
![IDEA创建Javaweb工程](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246200.png)

**第二步**

![创建Javaweb工程2](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246230.png)

**第三步**

![创建Javaweb工程3](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246254.png)

**第四步**

![创建Javaweb工程4](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246285.png)
...
![IDEA发布工程1](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246306.png)

**第二步**

![IDEA发布工程2](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246333.png)

**第三步**

![IDEA发布工程3-启动服务](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246354.png)

#### 2）war包发布

**第一步：使用<b>`jar -cvf war` <font color='blue'>包的名称</font>  <font color='purple'>当前目录中哪些资源要打入war</font></b>**

![jar命令](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246378.png)

![war包](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246401.png)

**第二步：把打好的war拷贝到tomcat的webapps目录中**

![拷贝war包到webapps](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246427.png)

**第三步：启动服务时，tomcat会自动解压。**

![启动Tomcat自动解压war包](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246451.png)
...
![默认应用1](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246475.png)

第二种：写一个独立的配置文件，文件名称为`ROOT.xml`。
​				注意：`ROOT`必须大写。当使用了独立的`ROOT.xml`文件时，`webapps`下`ROOT`应用就不是默认应用了。

![默认应用2](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246500.png)
...
![请求部分](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246530.jpg)
...
![响应部分](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246569.jpg)
...
![静态资源工程1](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246595.png)

![静态资源工程2](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246618.png)

**第二步：拷贝资源到工程的web目录中**

![静态资源工程3](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246647.png)

**第三步：在web.xml中配置默认主页**

![静态资源工程4](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246677.png)

**第四步：部署工程到Tomcat服务器**

![静态资源工程5](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246707.png)

**第五步：测试浏览器访问**

![静态资源工程6](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246738.png)

![静态资源工程7](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246773.png)
...
![动态资源工程](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246812.png)

![动态资源工程1](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246845.png)

**第二步：拷贝资源**

![动态资源工程2](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246867.png)

**第三步：配置默认主页**

![动态资源工程4](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246895.png)

**第四步：部署项目**

![动态资源工程3](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246922.png)
...
![前期准备](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246953.png)

**第一步：编写一个普通类实现Servlet接口或者继承GenericServlet类或者继承HttpServlet**

![编写Servlet](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246979.png)

**第二步：重写service方法，输出一句话**

![重写Service方法](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246006.png)

**第三步：在web.xml配置Servlet**

![配置Servlet](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246028.png)
...
![测试访问结果](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121246061.png)