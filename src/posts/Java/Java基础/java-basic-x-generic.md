...
![image-20220813173150842](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111451902.png)

- 调用泛型方法语法格式

![image-20220813173752432](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111451961.png)
...
![image-20220813191141893](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111451019.png)
...
![image-20220813191245583](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111451064.png)

- 擦除方法定义中的类型参数

擦除方法定义中的类型参数原则和擦除类定义中的类型参数是一样的，这里仅以擦除方法定义中的有限制类型参数为例。

![image-20220813191445499](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111451106.png)
