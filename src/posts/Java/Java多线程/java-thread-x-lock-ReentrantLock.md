...
![image-20220520161909794](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710494.png)

![image-20220520161943656](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710548.png)
...
![image-20220916214434623](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710610.png)
...
![image-20220916214515917.png](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202410181459714.png)
...
![image-20220916214704264](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710643.png)
...
![image-20220916214728531](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202410151621866.png)
说明: 由调用流程可知，t1线程成功获取了资源，可以继续执行。

- t2线程执行lock.lock，下图给出了方法调用中的主要方法。

![image-20220916214753399](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710672.png)

说明: 由上图可知，最后的结果是t2线程会被禁止，因为调用了LockSupport.park。

- t3线程执行lock.lock，下图给出了方法调用中的主要方法。

![image-20220916214810133](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710702.png)

说明: 由上图可知，最后的结果是t3线程会被禁止，因为调用了LockSupport.park。

- t1线程调用了lock.unlock，下图给出了方法调用中的主要方法。

![image-20220916214823518](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710731.png)

说明: 如上图所示，最后，head的状态会变为0，t2线程会被unpark，即t2线程可以继续运行。此时t3线程还是被禁止。

- t2获得cpu资源，继续运行，由于t2之前被park了，现在需要恢复之前的状态，下图给出了方法调用中的主要方法。

![image-20220916214840548](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710762.png)
...
![image-20220916214858271](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710795.png)

说明: 由上图可知，最终unpark t3线程，让t3线程可以继续运行。

- t3线程获取cpu资源，恢复之前的状态，继续运行。

![image-20220916214911379](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710829.png)

说明: 最终达到的状态是sync queue中只剩下了一个结点，并且该节点除了状态为0外，其余均为null。

- t3执行lock.unlock，下图给出了方法调用中的主要方法。

![image-20220916214924181](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111710860.png)
