---
aliases: 'ReentrantLock源码分析(二)-获取锁细节'
tags: 
cssclass:
source:
created: "2024-02-22 10:48"
updated: "2024-03-11 17:27"
---
...
![image-20220521202652797](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111726707.png)
...
![image-20220521205100169](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111726733.png)

从上图可以看出，跳出当前循环的条件是当“前置节点是头结点，且当前线程获取锁成功”。为了防止因死循环导致CPU资源被浪费，我们会判断前置节点的状态来决定是否要将当前线程挂起，具体挂起流程用流程图表示如下（shouldParkAfterFailedAcquire流程）：

![image-20220521205119638](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111726777.png)
...
![image-20220521205416054](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111726802.png)

当前节点是Head的后继节点。

![image-20220521205431385](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111726827.png)

当前节点不是Head的后继节点，也不是尾节点。

![image-20220521205446769](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403111726856.png)
