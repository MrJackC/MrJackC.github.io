...
![image-20220823204433162](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957438.png)
...
![image-20220823205453245](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957483.png)
...
![image-20220823210244539](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957521.png)
...
![image-20220823211503784](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957549.png)
...
![image-20220823212433809](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957582.png)

GC 开始前所有对象都是白色，GC 一开始所有根能够直达的对象被压到栈中，待搜索，此时颜色是灰色。然后灰色对象依次从栈中取出搜索子对象，子对象也会被涂为灰色，入栈。当其所有的子对象都涂为灰色之后该对象被涂为黑色。当 GC 结束之后灰色对象将全部没了，剩下黑色的为存活对象，白色的为垃圾。![java-jvm-gc-g1-5-1](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957616.gif)

#### 2.4.4 漏标问题

在remark过程中，黑色指向了白色，如果不对黑色重新扫描，则会漏标。会把白色D对象当作没有新引用指向从而回收掉。

![image-20220823213142683](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957645.png)
...
![image-20220823213416933](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957672.png)
...
![image-20220823213535491](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957700.png)
...
![image-20220823214154560](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403120957731.png)
