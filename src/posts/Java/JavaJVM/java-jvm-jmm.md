...
![image-20220821102907663](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005463.png)
...
![image-20220821193840673](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005515.png)
...
![image-20220821195604797](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005552.png)
...
![image-20220821195911052](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005586.png)
...
![image-20220821210137706](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005606.png)
...
![image-20220821210349129](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005630.png)

如上图所示，A 和 C 之间存在数据依赖关系，同时 B 和 C 之间也存在数据依赖关系。因此在最终执行的指令序列中，C 不能被重排序到 A 和 B 的前面（C 排到 A 和 B 的前面，程序的结果将会被改变）。但 A 和 B 之间没有数据依赖关系，编译器和处理器可以重排序 A 和 B 之间的执行顺序。下图是该程序的两种执行顺序：

![image-20220821210527038](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005658.png)
...
![image-20220821221032919](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005692.png)
...
![image-20220821221130820](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005714.png)
...
![image-20220821221411403](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005735.png)
...
![image-20220821221515932](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005769.png)

现在我们再假设这两个线程没有做同步，下面是这个未同步程序在顺序一致性模型中的执行示意图：

![image-20220821221533148](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005789.png)
...
![image-20220821224911143](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005820.png)
...
![image-20220821225117571](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005846.png)
...
![image-20220821225142202](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005874.png)
...
![image-20220821225252717](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005899.png)
...
![image-20220821225317117](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005920.png)
...
![image-20220821225356720](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005946.png)
...
![image-20220821225432119](https://cdn.jsdelivr.net/gh/MrJackC/PicGoImages/other/202403121005970.png)
