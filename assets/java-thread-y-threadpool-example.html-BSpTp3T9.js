import{_ as n,c as a,a as e,o as i}from"./app-DP7tPpgD.js";const l={};function p(c,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="线程池使用示例" tabindex="-1"><a class="header-anchor" href="#线程池使用示例"><span>线程池使用示例</span></a></h1><p>具体使用示例</p><div class="language- line-numbers-mode" data-ext="" data-title=""><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code" style="background-color:#282c34;--shiki-dark-bg:#282c34;color:#abb2bf;--shiki-dark:#abb2bf;" tabindex="0"><code><span class="line"><span>public class Test {</span></span>
